"""
Register the best XGBoost model in MLflow Model Registry.
...
def register_best_model():
    ...
    if not valid_runs:
        ...
        print("   python pipelines/mlflow_xgboost/train_xgboost_mlflow.py --data-file gold_GCF_10y_1d.csv --experiment-name xgboost_gold_price")
        return
    ...
    print(f"   Parameters: n_estimators={best_run.data.params.get('n_estimators')}, "
          f"max_depth={best_run.data.params.get('max_depth')}, "
          f"learning_rate={best_run.data.params.get('learning_rate')}")
