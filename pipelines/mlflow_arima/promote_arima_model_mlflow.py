"""
Promote a registered ARIMA model to Production using Aliases (MLflow 2.0+).
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Promote ARIMA model to Production stage")
